...
<html>
    ...
    <body class="security">
     ...
     <h2 class="signPro"><strong>Add</strong></h2>
      <div >
          @if(Session::has('suc'))
 ...
 <form class="col-md-12" action="{{url('/distributors.distCreateAccount')}}" method="POST">
 @csrf
  ...
  <div>
    <button class="btn btn-primary" type="submit" name="submit" >Create a new account</button>
  </div>
            </form></div>
     </div>
