...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
            <li class="active"><a href="{{ url('/customers.delete') }}"><i class="bx bx-user"></i> <span>Delete</span></a></li>
...
@foreach ( $custs as $row )
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>User Name:</strong> {{ $row['cname'] }}</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Password :</strong> {{$row['password'] }}</li>
