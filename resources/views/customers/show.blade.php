...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          <li class="active"><a href="{{ url('/customers.show') }}"><i class="bx bx-user"></i> <span>My Profile</span></a></li>
            <li><a href="{{ url('/customers.welcome') }}"><i class="bx bx-home"></i> Main Page</a></li>
