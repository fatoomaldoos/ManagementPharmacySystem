    ...
    <nav class="nav-wrapper indigo">
      <div class="container">
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li><a href="{{ url('/customers.inbox') }}" class="btn-floating indigo darken-4">
            <i class="material-icons">notifications</i></a></li>
            @foreach ($note as $row )
            @if($username==$row->cname)
            <li><span class="badge pink-text purble " id="cnote">{{ $row->counter}}</span></li>
                  @endif
            @endforeach
        </ul>
      </div>
       ...
       <div class="row py-5">
               ...
               <h3 style="color: rgb(206, 194, 200)">My Inbox</h3>
                ...
                <h3 style="color: rgb(206, 194, 200)">Delete Profile</h3>
                   ...
                   <div class="col-md-4 item">
                    <a href="/customers.showMedicine">
                 <i class="fa fa-medkit"></i></a>
                <h3 style="color: rgb(206, 194, 200)">My medicine</h3>
                   </div>
