    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
            ...
            <li><a href="{{ url('/customers.showMedicine') }}"><i class="bx bx-envelope"></i> <span>Show Medicine</span></a></li>
                  <li><a href="{{ url('/customers.eEditmed') }}"><i class="bx bx-envelope"></i> <span>Edit Medicine</span></a></li>
                 <li><a href="{{ url('/customers.empDeleteMed') }}"><i class="bx bx-envelope"></i> <span>Delete Medicine</span></a></li>
       ...
       <div style="color: red">{{ session('msg') }}</div>
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              ...
              <div>
                <form action="{{ url('/customers.deleteMedicine/'.$row['id']) }}" method="POST">
                @csrf
                @method('DELETE')
