...
<div class="cont">
	<div class="head"><nav>
		...
		<ul>
			<li><a class="active" href="customers.custAll">Home</a></li>
			<li><a class="active" href="customers.custToemp">message</a></li>
			@foreach ($note as $row )
			<li><span class="badge pink-text purble "id="notif">{{ $row['ucounter'] }}</span></li>
			@endforeach
		</ul>
	</nav></div>
<div class="bod" id='med'>
			...
			<div class="message">
				<li><i class="icofont-rounded-right"></i> <strong style="color:rgb(24, 22, 22)">Customer:</strong> {{ $row['cname'] }}</li>
