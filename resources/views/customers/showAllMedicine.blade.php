...
<body>
      ...
      <nav>
        ...
        <ul>
            <li><a href="/customers.custAll">Setting</a></li>
            
            <li>
                <label for="btn-1" class="show"> Medicine</label>
                <a href="#">Medicine</a>
                <input type="checkbox" id="btn-1">
                <ul>
                  
                  <li><a href="customers.addMedicine">add</a></li>
                  <li><a href="customers.showAllMedicine">Show</a></li>
  ...
  <td> <div>
               <form action="{{ url('/customers.eEditmed') }}" method="POST">
               @csrf
