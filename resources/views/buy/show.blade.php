...
<body>
      ...
      <nav>
        ...
        <ul>
          ...
          <li>
            <label for="btn-1" class="show"> {{ __('lang.Enters') }}</label>
            <a href="#">{{ __('lang.Enters') }}</a>
            <ul>
              <li> <label for="btn-3" class="show">{{ __('lang.show') }}</label>
                <a href="buy.show">{{ __('lang.show') }} <span class="fa fa-plus"></span></a>
                <input type="checkbox" id="btn-3">

              </li>
              <li> <label for="btn-3" class="show"> {{ __('lang.add') }} </label>
                <a href="buy.add"> {{ __('lang.add') }} <span class="fa fa-plus"></span></a>
                <input type="checkbox" id="btn-3">

              </li>
              <li> <label for="btn-3" class="show">{{ __('lang.bells') }} </label>
                <a href="show.showTodayB"> {{ __('lang.bells') }} <span class="fa fa-plus"></span></a>
                <input type="checkbox" id="btn-3">
          ...
          <li><a href="/buy.main">{{ __('lang.home') }}</a></li>
