...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          <li class="active"><a href="{{ url('/sells.parcode') }}"><i class="bx bx-envelope"></i> <span>Add</span></a></li>
          
          <li><a href="{{ url('/sells.show') }}"><i class="bx bx-envelope"></i> <span>Show</span></a></li>
          <li><a href="{{ url('/sells.allCust') }}"><i class="bx bx-envelope"></i> <span>Customers</span></a></li>
          <li><a href="{{ url('/sells.customers') }}"><i class="bx bx-envelope"></i> <span>bells of Customers</span></a></li>
