...
<div class="container text-center py-5">
       ...
       <div class="row py-5">
                 ...
                 <div class="col-md-4 item">
                   <a href="/employeesPage">
                <i class="fa fa-medkit"></i></a>
               <h3>Employees</h3>
 
               <p class="text-muted pt-2">Lorem ipsum dolor sit amrferendis tempora porro perspiciatis? Quod est iustnis! Voluptatum, asperiores fuga!</p>
                  </div>
                  ...
                  <p>Lorem ipsum dolor sit amrferendis tempora porro perspiciatis? Quod est iustnis! Voluptatum, asperiores fuga!</p>
                  </div>
                  
                  
                  <div class="col-md-4 item">
                  <a href="/medicinesPage">
                    <i class='fas fa-comments-dollar'></i></a>
                    <h3>Sales System</h3>
                  ...
                  <div class="col-md-4 item">
                  <a href="/companisePage">
                    <i class='fas fa-building'></i></a>
                    <h3>informatin of companies</h3>
                  ...
                  <p>to connect with other employee and left them a note ...</p>
                  </div>
  
                  <div class="col-md-4 item">
                  <a href="/medicine.medicinesPage">
                    <i class='fas fa-capsules' ></i></a>
