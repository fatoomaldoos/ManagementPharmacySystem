...
<body>
      ...
      <nav>
        ...
        <ul>
            <li><a href="/company.main">Setting</a></li>
            
            <li>
                <label for="btn-1" class="show"> Section</label>
                <a href="#">Section</a>
                <input type="checkbox" id="btn-1">
                <ul>
                  
                  <li><a href="section.addSection">add</a></li>
                  <li><a href="section.show">Edit & delete</a></li>
 ...
 <td> <div>
  <form action="{{ url('/section.showToEdit')}}" method="POST">
  @csrf
