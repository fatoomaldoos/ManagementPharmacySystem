...
<div class="cont">
	<div class="head"><nav>
		...
		<ul>
			...
			<li><a class="active" href="order.orderSent">message</a></li>
			@foreach ($note as $row )
...
<div class="bod" id='med'>
			...
			<div class="message">
			<li><i class="icofont-rounded-right"></i> <strong>Employee Name:</strong> {{ $row['uname'] }}</li>
			...
			<li><i class="icofont-rounded-right"></i> <strong>Ordered at:</strong> {{ $row['created_at'] }}</li>
