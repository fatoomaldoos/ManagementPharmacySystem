        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/order.orderPage') }}" method="POST">
                      @csrf
                      <div class="input-group">
                          <input class="input--style-3" type="text" value="{{ $uname }}" name="uname">
                      </div>
                      <div class="input-group">
                          <input class="input--style-3 js-datepicker" type="text" placeholder="name of medicine" name="medname">
