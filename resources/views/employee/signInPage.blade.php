...
<html>
 ...
 <form class="col-md-12" action="/employee.signInPage" method="POST">
 @csrf
  <div>
    <label for="validationCustomUsername" class="form-label"> {{ __('lang.Username') }}</label>
  ...
  <div>
    <label for="validationCustom05" class="form-label"> {{ __('lang.Password') }}</label>
  ...
  <div>
    <button class="btn btn-primary" type="submit" name="submit" > {{ __('lang.Sign in') }}</button>
  </div>
            </form></div>
     </div>
