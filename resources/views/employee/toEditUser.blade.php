...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          <li class="active"><a href="#about"><i class="bx bx-home"></i> <span>My Informations</span></a></li>
          <li class="active"><a href="{{ url('allUser') }}"><i class="bx bx-home"></i> <span>Informations of all users</span></a></li>
          <li><a href="{{ url('/editUser') }}"><i class="bx bx-user"></i> <span>Edit</span></a></li>
          <li><a href="{{ url('/deleteUser') }}"><i class="bx bx-envelope"></i> Delete</a></li>
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
               ...
               <div>
               <form action="{{ url('/employee.toEditUser/'.$row['id']) }}" method="POST">
               @csrf
               @method('DELETE')
