...
<body>
      ...
      <nav>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
                  ...
                  <li> <label for="btn-3" class="show">today +</label>
                    <a href="show.addTodayMin">today <span class="fa fa-plus"></span></a>
                  ...
                  <li> <label for="btn-3" class="show"> year +</label>
                    <a href="show.showYearMin"> year <span class="fa fa-plus"></span></a>
                    <input type="checkbox" id="btn-3">
          ...
          <li> <form class="col-md-12" action="{{url('/pdf.minYear')}}" method="POST">
            @csrf
          <div>
        
            <label for="validationCustom05" class="form-label"></label>
            <input type="hidden" class="form-control" id="validationCustom05" name="date" value={{ $now }} required>
...
@if($now==date('Y',strtotime($row['date'])))
