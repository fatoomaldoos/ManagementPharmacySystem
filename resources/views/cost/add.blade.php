    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li><a href="/cost.edit"><i class="bx bx-trash"></i>Edit</a></li>
...
<main id="main">
   ...
   <div class="myBorder">
       ...
       {{--   <form action="@dd($request->all())" method='POST' > --}}
        ...
        <form action="{{ url('/cost.add') }}" method='POST' >
        @csrf
     ...
     <div class="col-md-3" >
      ...
      <div>
       ...
       <input type="text" class="form-control" id="validationCustom05" name='add' required>
      </div>
