        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/reverse.reverse')}}" method="POST">
                        @csrf
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Name of distributors" name="dname">
                        </div>
                        <div  >
                            
                           
                            
                            <input class="input--style-3" type="number"  value="{{ $id }}" name="id" style="visibility: hidden">
