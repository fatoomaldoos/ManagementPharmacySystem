...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          <li class="active"><a href="{{ url('/chatOrder') }}"><i class="bx bx-envelope"></i> <span>My Inbox</span></a></li>
          
          <li><a href="{{ url('/distAll') }}"><i class="bx bx-envelope"></i> <span>Send Order</span></a></li>
                <li><a href="{{ url('/showOrder') }}"><i class="bx bx-envelope"></i> <span>Show Order</span></a></li>
               <li><a href="{{ url('/eDeleteDist') }}"><i class="bx bx-envelope"></i> <span>Delete Distributors</span></a></li>
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
               ...
               <div>
               <form action="{{ url('/all.distAll/'.$dist['id']) }}" method="POST">
               @csrf
